...
psu_resource_name = 'USB0::0xDEAD::0xBEEF::MY12345678::INSTR' 
dmm_resource_name = 'USB0::0xDEAD::0xBEEF::MY12345678::INSTR'  
...
for voltage in np.arange(0, final_voltage + voltage_step, voltage_step):
    ...
    measured_voltage = dmm.query()
    measured_current = dmm.query()
    ###############################################################
